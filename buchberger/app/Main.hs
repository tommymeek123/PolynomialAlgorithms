...
--    putStrLn $ "gm * im = " ++ (formatSS . show) (gm <> im)
    let fpstring = "-4x_3^4 x_2 x_5^2 - 5 - 2x_9 - 7/2 x_1^2 x_3 x_2^5 x_9^3 + 6 + 6 x_2^4 x_5^3 - 10/3 + 9/3 x_4^9x_3^9x_2^9"
        ...
        fp = (fromString fpstring) :: P.Polynomial RP.Q 13 RP.Lex
        gp = (fromString gpstring) :: P.Polynomial RP.Q 13 RP.Lex
        hp = (fromString hpstring) :: P.Polynomial RP.Q 13 RP.Lex
        zero = fromString "5 - 5" :: P.Polynomial RP.Q 13 RP.Lex
        one1 = fromInteger 1 :: P.Polynomial RP.Q 13 RP.Lex
        five = fromInteger 5 :: P.Polynomial RP.Q 13 RP.Lex
        one2 = fromString "5 + 7 - 20 + 9" :: P.Polynomial RP.Q 13 RP.Lex
